...
__conda_setup="$('/run/media/consectaneus/_home/consectaneus/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/run/media/consectaneus/_home/consectaneus/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/run/media/consectaneus/_home/consectaneus/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/run/media/consectaneus/_home/consectaneus/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
